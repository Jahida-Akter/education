...
const CONCEPTS = [
  { term: "Leverage", def: "A tool that allows you to control a larger position with a smaller initial deposit. Leverage amplifies both profits and losses equally." },
  { term: "Margin", def: "The deposit required by a broker to open and maintain a leveraged position. If your account falls below the margin requirement, your position may be closed automatically." },
  { term: "Spread", def: "The difference between the buy (ask) price and the sell (bid) price of an instrument. This is the primary cost of each trade." },
  { term: "Stop-Loss Order", def: "An instruction to close a trade automatically once it reaches a specified loss level. Stop-loss orders help manage downside risk but are not guaranteed in fast-moving markets." },
  { term: "Take-Profit Order", def: "An instruction to close a trade automatically when it reaches a target profit level." },
  { term: "Volatility", def: "A measure of how much and how quickly a market price changes. Higher volatility means larger potential moves in both directions." },
  { term: "Pip", def: "The smallest standard price move in a forex pair. For most currency pairs, one pip equals 0.0001 of the quoted price." },
  { term: "Long / Short", def: "Going 'long' means buying an asset expecting the price to rise. Going 'short' means selling an asset expecting the price to fall." },
];

const ASSET_CLASSES = [
  { name: "Forex (Currency Pairs)", desc: "The foreign exchange market is the largest and most liquid financial market in the world. Traders speculate on the relative value of one currency against another, such as EUR/USD or GBP/JPY. The forex market operates 24 hours a day, five days a week." },
  { name: "Commodities", desc: "Commodities include physical goods such as gold, silver, crude oil, and natural gas. They are traded on global exchanges and their prices are influenced by supply and demand, geopolitical events, and macroeconomic data." },
  { name: "Stock Indices", desc: "An index tracks the performance of a group of stocks, such as the S&P 500 (US), FTSE 100 (UK), or DAX (Germany). Trading indices provides exposure to an entire economy or sector rather than a single company." },
  { name: "Shares (Equities)", desc: "Shares represent ownership in a publicly listed company. They can be bought and held as investments, or traded as CFDs to speculate on short-term price movements without owning the underlying stock." },
];
    ...
    <main style={{ minHeight: "100vh", background: "#ffffff", color: "#111827", fontFamily: "'Segoe UI', system-ui, Arial, sans-serif", lineHeight: 1.6 }}>
      ...
      <div style={{ background: "#fefce8", borderBottom: "2px solid #fde68a", padding: "10px 24px", textAlign: "center" }}>
        <p style={{ margin: 0, fontSize: 13, color: "#92400e", fontWeight: 600 }}>
          ...
          <a href="#risk-disclosure" style={{ color: "#b45309", textDecoration: "underline" }}>Risk Disclosure</a> before proceeding.
        </p>
      </div>
      ...
      <header style={{ borderBottom: "1px solid #e5e7eb", padding: "14px 32px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
          ...
          <nav style={{ display: "flex", gap: 20, fontSize: 13, color: "#6b7280", flexWrap: "wrap" }}>
      ...
      <section style={{ background: "#f9fafb", borderBottom: "1px solid #e5e7eb", padding: "56px 32px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <p style={{ margin: "0 0 24px", fontSize: 16, color: "#4b5563", maxWidth: 620, lineHeight: 1.75 }}>
            This page provides free, impartial educational information about how financial markets work,
            the instruments available to retail traders, and the risks involved in trading.
          ...
          <div style={{ display: "inline-block", background: "#fef3c7", border: "1px solid #fcd34d", borderRadius: 8, padding: "12px 20px", fontSize: 13, color: "#78350f", maxWidth: 620 }}>
            <strong>Important Notice:</strong> This content is for educational purposes only and does not constitute
            investment advice, financial guidance, or a recommendation to trade. Always seek independent
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 32px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 28 }}>
            <div>
              ...
              <p style={{ fontSize: 14, color: "#4b5563", margin: 0, lineHeight: 1.8 }}>
                A Contract for Difference (CFD) is a financial derivative that allows you to speculate on the
                price movement of an asset without owning the underlying asset. Your profit or loss is
                determined by the difference between the opening and closing price of your position.
              </p>
              <p style={{ fontSize: 14, color: "#4b5563", marginTop: 12, lineHeight: 1.8 }}>
                CFDs are leveraged instruments. A relatively small deposit (called margin) can control a
                much larger position. While leverage can magnify gains, it equally magnifies losses
                and can exceed your initial deposit.
              </p>
            </div>
            <div>
              ...
              <p style={{ fontSize: 14, color: "#4b5563", margin: 0, lineHeight: 1.8 }}>
                ...
                markets in real time. Through the platform, you can view live price quotes, place buy and
                sell orders, set risk management parameters such as stop-loss levels, and monitor your open positions.
              </p>
              <p style={{ fontSize: 14, color: "#4b5563", marginTop: 12, lineHeight: 1.8 }}>
                Regulated brokers are authorised and supervised by financial authorities in their country
                of operation. Before opening an account, it is important to verify that a broker is
                properly licensed in your jurisdiction.
              </p>
            </div>
            <div>
              <h3 style={{ fontSize: 17, fontWeight: 700, color: "#111827", marginBottom: 10 }}>Who Trades Financial Markets?</h3>
              <p style={{ fontSize: 14, color: "#4b5563", margin: 0, lineHeight: 1.8 }}>
                Participants in financial markets range from large institutional investors (banks, hedge funds,
                pension funds) to individual retail traders. Retail participation has grown significantly
                with the availability of online platforms, but retail traders typically trade at a significant
                informational and resource disadvantage compared to professional institutions.
              </p>
              <p style={{ fontSize: 14, color: "#4b5563", marginTop: 12, lineHeight: 1.8 }}>
                Regulatory bodies in most countries require that brokers disclose the percentage of retail
                clients who lose money trading their products. This figure is typically between 67% and 80%
                across regulated brokers.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="asset-classes" style={{ padding: "48px 0 40px" }}>
          ...
          <p style={{ fontSize: 14, color: "#4b5563", maxWidth: 680, marginBottom: 28, lineHeight: 1.8 }}>
            The following are the main categories of financial instruments available to retail traders
            through online platforms. Each carries its own risk profile and market characteristics.
          </p>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 20 }}>
            {ASSET_CLASSES.map((a) => (
              <div key={a.name} style={{ background: "#f9fafb", border: "1px solid #e5e7eb", borderRadius: 10, padding: "22px 20px" }}>
        ...
        <section id="key-concepts" style={{ padding: "48px 0 40px" }}>
          ...
          <div style={{ width: 48, height: 3, background: "#059669", borderRadius: 2, marginBottom: 24 }} />
          <p style={{ fontSize: 14, color: "#4b5563", maxWidth: 680, marginBottom: 28, lineHeight: 1.8 }}>
            Before placing any trade, it is essential to understand the following terms. A failure to
            fully understand how leveraged products work is one of the most common causes of losses
            among new traders.
          </p>
        ...
        <section style={{ padding: "48px 0 40px" }}>
          ...
          <p style={{ fontSize: 14, color: "#4b5563", maxWidth: 680, marginBottom: 28, lineHeight: 1.8 }}>
            Retail traders must understand that trading leveraged financial products is inherently risky.
            The following points represent important risk factors that every person should consider
            before trading any live account:
          </p>
          <ul style={{ margin: 0, padding: 0, listStyle: "none", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 12 }}>
            {RISKS.map((r) => (
              <li key={r} style={{ display: "flex", gap: 10, alignItems: "flex-start", background: "#fff7f7", border: "1px solid #fecaca", borderRadius: 8, padding: "14px 16px", fontSize: 13, color: "#374151", lineHeight: 1.75 }}>
      ...
      <section id="risk-disclosure" style={{ background: "#fafafa", borderTop: "1px solid #e5e7eb", padding: "48px 32px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 12, color: "#6b7280", lineHeight: 1.9, margin: "0 0 12px" }}>
            Trading foreign exchange (forex), contracts for difference (CFDs), and other leveraged financial
            instruments on margin carries a high degree of risk and may not be suitable for all investors.
            The high degree of leverage can work against you as well as for you. Before deciding to trade
            leveraged financial products, you should carefully consider your investment objectives, level
            of trading experience, and risk appetite.
          </p>
          <p style={{ fontSize: 12, color: "#6b7280", lineHeight: 1.9, margin: "0 0 12px" }}>
            There is a possibility that you could sustain a loss of some or all of your initial investment.
            Therefore, you should not invest money that you cannot afford to lose entirely. You should be
            aware of all the risks associated with trading leveraged products and seek advice from an
            independent, authorised financial adviser if you have any doubts.
          </p>
          <p style={{ fontSize: 12, color: "#6b7280", lineHeight: 1.9, margin: "0 0 12px" }}>
            Past performance of any trading strategy, signal service, algorithm, or individual instrument
            is not indicative of future results. Any examples, simulations, or historical data presented
            for educational or illustrative purposes should not be interpreted as a guarantee of future outcomes.
          </p>
          <p style={{ fontSize: 12, color: "#6b7280", lineHeight: 1.9, margin: 0 }}>
            The content on this page is intended solely for educational and informational purposes. It does
            not constitute investment advice, a solicitation, or an offer to buy or sell any financial
            instrument. Regulatory requirements for trading leveraged products vary by country. It is your
            responsibility to ensure that your use of any trading platform or service complies with the
      ...
      <footer style={{ borderTop: "1px solid #e5e7eb", padding: "20px 32px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: 12, fontSize: 12, color: "#9ca3af" }}>
          <span>&copy; {new Date().getFullYear()} TradeSmart Education. This site provides educational content only and does not offer financial advice or investment services.</span>
